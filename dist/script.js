...
function showInfo(){
	document.getElementById("e-info").style.display="block";
}
function showInfo2(){
	document.getElementById("e-info2").style.display="block";
}
...
function hideInfo2(){
	document.getElementById("e-info2").style.display="none";
}
function showSchoolInfo(){
	document.getElementById("e-details").style.display="flex";
	document.getElementById("e-info").style.display="none";
}
function closeSchoolInfo(){
	document.getElementById("e-details").style.display="none";
}
function hideSchool(){
  document.getElementById('elem-icon').style.display="none";
}
